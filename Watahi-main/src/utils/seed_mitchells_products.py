...
load_dotenv(r"c:\Users\Ahamed Najah\Desktop\Artificizen\Mitchell's\Watahi-main\.env")

# Add Watahi-main to path so imports work correctly
sys.path.append(r"c:\Users\Ahamed Najah\Desktop\Artificizen\Mitchell's\Watahi-main")
