...
function SignIn() {
  ...
  >
    ...
    marginBottom: "18px"
                ...
                <span style={{ fontSize: ".72rem", fontWeight: 700, letterSpacing: ".08em", color: "#1DB87A", textTransform: "uppercase" }}>Live — answering calls now</span>
              </div>
              <h2 style={{
    margin: 0,
  ...
  >
    ...
    color: "#fff"
                ...
                <div style={{ marginLeft: "auto", display: "flex", gap: "2px" }}>
                  {Array.from({ length: 5 }).map((_, i) => <svg key={i} width="11" height="11" fill="#C8973A" viewBox="0 0 24 24">
  ...
  >
            ...
            {(isMobile || isTablet) && <div style={{ display: "flex", alignItems: "center", gap: "9px", marginBottom: "32px" }}>
                <MitchellsLogo height={26} color="#0F0F1A" />
